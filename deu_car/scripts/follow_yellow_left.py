...
class Follow_yellow_left:
    ...
    def image_callback(self, msg):
        ...
        mask_white_right = cv2.inRange(hsv, lower_white, upper_white)
        ...
        mask_white_right[0:search_top, 0:w] = 0
        mask_white_right[search_bot:h, 0:w] = 0
        mask_white_right[0:h, 0:w/2] = 0
        if self.only_left:
